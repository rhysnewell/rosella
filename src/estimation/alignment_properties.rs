...
// Modified from Varlociraptor, All credit goes to Johannes and David. Just needed to change
// Bam reader types and generate alignment properties per read to avoid reader being used up.
// Also added in some more structural variant types used by SVIM and SVIM-asm
