...
impl RecoverEngine {
    pub fn new(args: &RecoverArgs) -> Result<Self> {
        ...
        Ok(Self {
            ...
            weight_by_length: args.distance.weight_by_length,
            weight_before_scatter: args.distance.weight_before_scatter,
            reweigh: args.distance.reweigh,
            dissolve,
